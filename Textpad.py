...
main_program=tk.Tk()
main_program.geometry('1200x800')
main_program.title('Text Editor')
#main_program.wm_iconbitmap('icon.ico')
...
# view icons 
tool_icon=tk.PhotoImage(file='icons/tool_bar.png')
status_icon=tk.PhotoImage(file='icons/status_bar.png')
...
color_icons=(light_default_icon,light_plus_icon,dark_icon,monokai_icon,night_blue_icon,red_icon)
...
# **********************************************  TOOLBAR *************************************
tool_bar=ttk.Label(main_program)
...
font_size.current(4)  # 4 is index
...
text_editor=tk.Text(main_program)
text_editor.config(wrap='word',relief=tk.FLAT)

scroll_bar=tk.Scrollbar(main_program)
...
status_bar=ttk.Label(main_program,text='Status Bar')
...
def open_file(event=None):
    ...
    try:
        ...
        return
    main_program.title(os.path.basename(url))
...
view.add_checkbutton(label='Status Bar',onvalue=1,offvalue=False,variable=show_statusbar,image=status_icon,compound=tk.LEFT,command=hide_statusbar)
...
main_program.config(menu=main_menu)

##### Binding Shortcut keys
main_program.bind('<Control-n>',new_file)
main_program.bind('<Control-o>',open_file)
main_program.bind('<Control-s>',save_file)
main_program.bind('<Control-Alt-s>',save_as_file)
main_program.bind('<Control-q>',exit_func)
main_program.bind('<Control-f>',find_func)
